...
namespace OpenCVForUnity.Structured_lightModule
{
    public partial class SinusoidalPattern : StructuredLightPattern
    {
        ...
        /// </param>
        public void unwrapPhaseMap(Mat wrappedPhaseMap, Mat unwrappedPhaseMap, in Vec2d camSize, Mat shadowMask)
        {
            ThrowIfDisposed();
            ...
            structured_1light_SinusoidalPattern_unwrapPhaseMap_10(nativeObj, wrappedPhaseMap.nativeObj, unwrappedPhaseMap.nativeObj, camSize.Item1, camSize.Item2, shadowMask.nativeObj);
        ...
        /// Mask used to discard shadow regions.
        /// </param>
        public void unwrapPhaseMap(Mat wrappedPhaseMap, Mat unwrappedPhaseMap, in Vec2d camSize)
        {
            ThrowIfDisposed();
            if (wrappedPhaseMap != null) wrappedPhaseMap.ThrowIfDisposed();
            if (unwrappedPhaseMap != null) unwrappedPhaseMap.ThrowIfDisposed();

            structured_1light_SinusoidalPattern_unwrapPhaseMap_11(nativeObj, wrappedPhaseMap.nativeObj, unwrappedPhaseMap.nativeObj, camSize.Item1, camSize.Item2);
