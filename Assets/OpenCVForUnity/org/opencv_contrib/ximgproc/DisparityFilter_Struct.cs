...
namespace OpenCVForUnity.XimgprocModule
{
    public partial class DisparityFilter : Algorithm
    {
        ...
        ///      stereo-pair.
        /// </param>
        public void filter(Mat disparity_map_left, Mat left_view, Mat filtered_disparity_map, Mat disparity_map_right, in Vec4i ROI, Mat right_view)
        {
            ThrowIfDisposed();
            ...
            ximgproc_DisparityFilter_filter_10(nativeObj, disparity_map_left.nativeObj, left_view.nativeObj, filtered_disparity_map.nativeObj, disparity_map_right.nativeObj, ROI.Item1, ROI.Item2, ROI.Item3, ROI.Item4, right_view.nativeObj);
        ...
        ///      stereo-pair.
        /// </param>
        public void filter(Mat disparity_map_left, Mat left_view, Mat filtered_disparity_map, Mat disparity_map_right, in Vec4i ROI)
        {
            ThrowIfDisposed();
            if (disparity_map_left != null) disparity_map_left.ThrowIfDisposed();
            if (left_view != null) left_view.ThrowIfDisposed();
            ...
            ximgproc_DisparityFilter_filter_11(nativeObj, disparity_map_left.nativeObj, left_view.nativeObj, filtered_disparity_map.nativeObj, disparity_map_right.nativeObj, ROI.Item1, ROI.Item2, ROI.Item3, ROI.Item4);
