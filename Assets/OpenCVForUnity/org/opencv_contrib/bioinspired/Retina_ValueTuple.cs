...
namespace OpenCVForUnity.BioinspiredModule
{
    public partial class Retina : Algorithm
    {
        ...
        /// </returns>
        public (double width, double height) getOutputSizeAsValueTuple()
        {
            ThrowIfDisposed();
        ...
        ///  @overload
        /// </remarks>
        public static Retina create(in (double width, double height) inputSize)
        {
        ...
        /// </param>
        public static Retina create(in (double width, double height) inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling, float reductionFactor, float samplingStrength)
        {
        ...
        ///      the log scale that is applied
        /// </param>
        public static Retina create(in (double width, double height) inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling, float reductionFactor)
        {
        ...
        ///      the log scale that is applied
        /// </param>
        public static Retina create(in (double width, double height) inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling)
        {
        ...
        ///      the log scale that is applied
        /// </param>
        public static Retina create(in (double width, double height) inputSize, bool colorMode, int colorSamplingMethod)
        {
        ...
        ///      the log scale that is applied
        /// </param>
        public static Retina create(in (double width, double height) inputSize, bool colorMode)
        {
