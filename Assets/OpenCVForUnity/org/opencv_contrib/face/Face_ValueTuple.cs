...
namespace OpenCVForUnity.FaceModule
{
    public partial class Face
    {
        ...
        ///  }
        /// </code>
        public static void drawFacemarks(Mat image, Mat points, in (double v0, double v1, double v2, double v3) color)
        {
            if (image != null) image.ThrowIfDisposed();
            if (points != null) points.ThrowIfDisposed();

            face_Face_drawFacemarks_10(image.nativeObj, points.nativeObj, color.v0, color.v1, color.v2, color.v3);
