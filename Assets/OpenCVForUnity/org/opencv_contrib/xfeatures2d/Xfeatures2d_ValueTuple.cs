...
namespace OpenCVForUnity.Xfeatures2dModule
{
    public partial class Xfeatures2d
    {
        ...
        /// </param>
        public static void matchGMS(in (double width, double height) size1, in (double width, double height) size2, MatOfKeyPoint keypoints1, MatOfKeyPoint keypoints2, MatOfDMatch matches1to2, MatOfDMatch matchesGMS, bool withRotation, bool withScale, double thresholdFactor)
        {
        ...
        ///          If your images have big rotation and scale changes, please set withRotation or withScale to true.
        /// </param>
        public static void matchGMS(in (double width, double height) size1, in (double width, double height) size2, MatOfKeyPoint keypoints1, MatOfKeyPoint keypoints2, MatOfDMatch matches1to2, MatOfDMatch matchesGMS, bool withRotation, bool withScale)
        {
            if (keypoints1 != null) keypoints1.ThrowIfDisposed();
            if (keypoints2 != null) keypoints2.ThrowIfDisposed();
            if (matches1to2 != null) matches1to2.ThrowIfDisposed();
        ...
        ///          If your images have big rotation and scale changes, please set withRotation or withScale to true.
        /// </param>
        public static void matchGMS(in (double width, double height) size1, in (double width, double height) size2, MatOfKeyPoint keypoints1, MatOfKeyPoint keypoints2, MatOfDMatch matches1to2, MatOfDMatch matchesGMS, bool withRotation)
        {
            if (keypoints1 != null) keypoints1.ThrowIfDisposed();
            if (keypoints2 != null) keypoints2.ThrowIfDisposed();
            if (matches1to2 != null) matches1to2.ThrowIfDisposed();
        ...
        ///          If your images have big rotation and scale changes, please set withRotation or withScale to true.
        /// </param>
        public static void matchGMS(in (double width, double height) size1, in (double width, double height) size2, MatOfKeyPoint keypoints1, MatOfKeyPoint keypoints2, MatOfDMatch matches1to2, MatOfDMatch matchesGMS)
        {
            if (keypoints1 != null) keypoints1.ThrowIfDisposed();
            if (keypoints2 != null) keypoints2.ThrowIfDisposed();
            if (matches1to2 != null) matches1to2.ThrowIfDisposed();
