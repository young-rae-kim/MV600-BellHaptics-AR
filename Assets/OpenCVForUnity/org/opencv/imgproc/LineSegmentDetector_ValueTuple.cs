...
namespace OpenCVForUnity.ImgprocModule
{
    public partial class LineSegmentDetector : Algorithm
    {
        ...
        /// </param>
        public int compareSegments(in (double width, double height) size, Mat lines1, Mat lines2, Mat image)
        {
            ThrowIfDisposed();
        ...
        ///      in order for lines1 and lines2 to be drawn in the above mentioned colors.
        /// </param>
        public int compareSegments(in (double width, double height) size, Mat lines1, Mat lines2)
        {
            ThrowIfDisposed();
            if (lines1 != null) lines1.ThrowIfDisposed();
            if (lines2 != null) lines2.ThrowIfDisposed();
