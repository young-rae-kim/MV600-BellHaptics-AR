...
namespace OpenCVForUnity.ObjdetectModule
{
    public partial class Objdetect
    {
        ...
        /// </remarks>
        public static void drawDetectedMarkers(Mat image, List<Mat> corners, Mat ids, in Vec4d borderColor)
        {
            if (image != null) image.ThrowIfDisposed();
            if (ids != null) ids.ThrowIfDisposed();
            Mat corners_mat = Converters.vector_Mat_to_Mat(corners);
            objdetect_Objdetect_drawDetectedMarkers_10(image.nativeObj, corners_mat.nativeObj, ids.nativeObj, borderColor.Item1, borderColor.Item2, borderColor.Item3, borderColor.Item4);
        ...
        /// </remarks>
        public static void drawDetectedCornersCharuco(Mat image, Mat charucoCorners, Mat charucoIds, in Vec4d cornerColor)
        {
            if (image != null) image.ThrowIfDisposed();
            if (charucoCorners != null) charucoCorners.ThrowIfDisposed();
            if (charucoIds != null) charucoIds.ThrowIfDisposed();

            objdetect_Objdetect_drawDetectedCornersCharuco_10(image.nativeObj, charucoCorners.nativeObj, charucoIds.nativeObj, cornerColor.Item1, cornerColor.Item2, cornerColor.Item3, cornerColor.Item4);
        ...
        ///     Useful for debugging purposes.
        /// </remarks>
        public static void drawDetectedDiamonds(Mat image, List<Mat> diamondCorners, Mat diamondIds, in Vec4d borderColor)
        {
            if (image != null) image.ThrowIfDisposed();
            if (diamondIds != null) diamondIds.ThrowIfDisposed();
            Mat diamondCorners_mat = Converters.vector_Mat_to_Mat(diamondCorners);
            objdetect_Objdetect_drawDetectedDiamonds_10(image.nativeObj, diamondCorners_mat.nativeObj, diamondIds.nativeObj, borderColor.Item1, borderColor.Item2, borderColor.Item3, borderColor.Item4);
