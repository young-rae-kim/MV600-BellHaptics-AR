...
namespace OpenCVForUnity.ObjdetectModule
{
    public partial class CharucoBoard : Board
    {
        ...
        public CharucoBoard(in Vec2d size, float squareLength, float markerLength, Dictionary dictionary, Mat ids) :
                    base(DisposableObject.ThrowIfNullIntPtr(objdetect_CharucoBoard_CharucoBoard_10(size.Item1, size.Item2, squareLength, markerLength, dictionary.nativeObj, ids.nativeObj)))
        {
        ...
        public CharucoBoard(in Vec2d size, float squareLength, float markerLength, Dictionary dictionary) :
                    base(DisposableObject.ThrowIfNullIntPtr(objdetect_CharucoBoard_CharucoBoard_11(size.Item1, size.Item2, squareLength, markerLength, dictionary.nativeObj)))
        {
