...
namespace OpenCVForUnity.ObjdetectModule
{
    public partial class FaceDetectorYN : DisposableOpenCVObject
    {
        ...
        /// </param>
        public void setInputSize(in (double width, double height) input_size)
        {
            ThrowIfDisposed();
        ...
        public (double width, double height) getInputSizeAsValueTuple()
        {
            ThrowIfDisposed();
        ...
        /// </param>
        public static FaceDetectorYN create(string model, string config, in (double width, double height) input_size, float score_threshold, float nms_threshold, int top_k, int backend_id, int target_id)
        {
        ...
        /// the id of target device
        /// </param>
        public static FaceDetectorYN create(string model, string config, in (double width, double height) input_size, float score_threshold, float nms_threshold, int top_k, int backend_id)
        {
        ...
        /// the id of target device
        /// </param>
        public static FaceDetectorYN create(string model, string config, in (double width, double height) input_size, float score_threshold, float nms_threshold, int top_k)
        {
        ...
        /// the id of target device
        /// </param>
        public static FaceDetectorYN create(string model, string config, in (double width, double height) input_size, float score_threshold, float nms_threshold)
        {
        ...
        /// the id of target device
        /// </param>
        public static FaceDetectorYN create(string model, string config, in (double width, double height) input_size, float score_threshold)
        {
        ...
        /// the id of target device
        /// </param>
        public static FaceDetectorYN create(string model, string config, in (double width, double height) input_size)
        {
        ...
        /// the id of target device
        /// </param>
        public static FaceDetectorYN create(string framework, MatOfByte bufferModel, MatOfByte bufferConfig, in (double width, double height) input_size, float score_threshold, float nms_threshold, int top_k, int backend_id, int target_id)
        {
        ...
        /// the id of target device
        /// </param>
        public static FaceDetectorYN create(string framework, MatOfByte bufferModel, MatOfByte bufferConfig, in (double width, double height) input_size, float score_threshold, float nms_threshold, int top_k, int backend_id)
        {
            if (bufferModel != null) bufferModel.ThrowIfDisposed();
            if (bufferConfig != null) bufferConfig.ThrowIfDisposed();
            Mat bufferModel_mat = bufferModel;
        ...
        /// the id of target device
        /// </param>
        public static FaceDetectorYN create(string framework, MatOfByte bufferModel, MatOfByte bufferConfig, in (double width, double height) input_size, float score_threshold, float nms_threshold, int top_k)
        {
            if (bufferModel != null) bufferModel.ThrowIfDisposed();
            if (bufferConfig != null) bufferConfig.ThrowIfDisposed();
            Mat bufferModel_mat = bufferModel;
        ...
        /// the id of target device
        /// </param>
        public static FaceDetectorYN create(string framework, MatOfByte bufferModel, MatOfByte bufferConfig, in (double width, double height) input_size, float score_threshold, float nms_threshold)
        {
            if (bufferModel != null) bufferModel.ThrowIfDisposed();
            if (bufferConfig != null) bufferConfig.ThrowIfDisposed();
            Mat bufferModel_mat = bufferModel;
        ...
        /// the id of target device
        /// </param>
        public static FaceDetectorYN create(string framework, MatOfByte bufferModel, MatOfByte bufferConfig, in (double width, double height) input_size, float score_threshold)
        {
            if (bufferModel != null) bufferModel.ThrowIfDisposed();
            if (bufferConfig != null) bufferConfig.ThrowIfDisposed();
            Mat bufferModel_mat = bufferModel;
        ...
        /// the id of target device
        /// </param>
        public static FaceDetectorYN create(string framework, MatOfByte bufferModel, MatOfByte bufferConfig, in (double width, double height) input_size)
        {
            if (bufferModel != null) bufferModel.ThrowIfDisposed();
            if (bufferConfig != null) bufferConfig.ThrowIfDisposed();
            Mat bufferModel_mat = bufferModel;
