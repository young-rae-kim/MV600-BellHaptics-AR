...
namespace OpenCVForUnity.ObjdetectModule
{
    public partial class GridBoard : Board
    {
        ...
        public GridBoard(in Vec2d size, float markerLength, float markerSeparation, Dictionary dictionary, Mat ids) :
                    base(DisposableObject.ThrowIfNullIntPtr(objdetect_GridBoard_GridBoard_10(size.Item1, size.Item2, markerLength, markerSeparation, dictionary.nativeObj, ids.nativeObj)))
        {
        ...
        public GridBoard(in Vec2d size, float markerLength, float markerSeparation, Dictionary dictionary) :
                    base(DisposableObject.ThrowIfNullIntPtr(objdetect_GridBoard_GridBoard_11(size.Item1, size.Item2, markerLength, markerSeparation, dictionary.nativeObj)))
        {
