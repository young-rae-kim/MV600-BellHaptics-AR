...
namespace OpenCVForUnity.VideoioModule
{
    public partial class VideoWriter : DisposableOpenCVObject
    {
        ...
        /// </remarks>
        public VideoWriter(string filename, int fourcc, double fps, in (double width, double height) frameSize, bool isColor)
        {
        ...
        ///        but some internal functions inside FFMPEG swscale require even width/height.
        /// </remarks>
        public VideoWriter(string filename, int fourcc, double fps, in (double width, double height) frameSize)
        {
        ...
        /// </remarks>
        public VideoWriter(string filename, int apiPreference, int fourcc, double fps, in (double width, double height) frameSize, bool isColor)
        {
        ...
        ///      if multiple are available: e.g. cv::CAP_FFMPEG or cv::CAP_GSTREAMER.
        /// </remarks>
        public VideoWriter(string filename, int apiPreference, int fourcc, double fps, in (double width, double height) frameSize)
        {
        ...
        /// </remarks>
        public VideoWriter(string filename, int fourcc, double fps, in (double width, double height) frameSize, MatOfInt _params)
        {
        ...
        ///  @overload
        /// </remarks>
        public VideoWriter(string filename, int apiPreference, int fourcc, double fps, in (double width, double height) frameSize, MatOfInt _params)
        {
            if (_params != null) _params.ThrowIfDisposed();
            Mat _params_mat = _params;
        ...
        /// </remarks>
        public bool open(string filename, int fourcc, double fps, in (double width, double height) frameSize, bool isColor)
        {
            ThrowIfDisposed();
        ...
        ///      The method first calls VideoWriter::release to close the already opened file.
        /// </remarks>
        public bool open(string filename, int fourcc, double fps, in (double width, double height) frameSize)
        {
            ThrowIfDisposed();
        ...
        ///  @overload
        /// </remarks>
        public bool open(string filename, int apiPreference, int fourcc, double fps, in (double width, double height) frameSize, bool isColor)
        {
            ThrowIfDisposed();
        ...
        ///  @overload
        /// </remarks>
        public bool open(string filename, int apiPreference, int fourcc, double fps, in (double width, double height) frameSize)
        {
            ThrowIfDisposed();
        ...
        ///  @overload
        /// </remarks>
        public bool open(string filename, int fourcc, double fps, in (double width, double height) frameSize, MatOfInt _params)
        {
            ThrowIfDisposed();
            if (_params != null) _params.ThrowIfDisposed();
            Mat _params_mat = _params;
        ...
        ///  @overload
        /// </remarks>
        public bool open(string filename, int apiPreference, int fourcc, double fps, in (double width, double height) frameSize, MatOfInt _params)
        {
            ThrowIfDisposed();
            if (_params != null) _params.ThrowIfDisposed();
            Mat _params_mat = _params;
