...
namespace OpenCVForUnity.PhotoModule
{
    public partial class Photo
    {
        ...
        /// </param>
        public static void seamlessClone(Mat src, Mat dst, Mat mask, in Vec2d p, Mat blend, int flags)
        {
            ...
            photo_Photo_seamlessClone_10(src.nativeObj, dst.nativeObj, mask.nativeObj, p.Item1, p.Item2, blend.nativeObj, flags);
