...
namespace OpenCVForUnity.DnnModule
{
    public partial class Image2BlobParams : DisposableOpenCVObject
    {
        ...
        public Image2BlobParams(in Vec4d scalefactor, in Vec2d size, in Vec4d mean, bool swapRB, int ddepth, in Vec4d borderValue)
        {


            nativeObj = DisposableObject.ThrowIfNullIntPtr(dnn_Image2BlobParams_Image2BlobParams_11(scalefactor.Item1, scalefactor.Item2, scalefactor.Item3, scalefactor.Item4, size.Item1, size.Item2, mean.Item1, mean.Item2, mean.Item3, mean.Item4, swapRB, ddepth, borderValue.Item1, borderValue.Item2, borderValue.Item3, borderValue.Item4));
        ...
        public Image2BlobParams(in Vec4d scalefactor, in Vec2d size, in Vec4d mean, bool swapRB, int ddepth)
        {
            ...
            nativeObj = DisposableObject.ThrowIfNullIntPtr(dnn_Image2BlobParams_Image2BlobParams_12(scalefactor.Item1, scalefactor.Item2, scalefactor.Item3, scalefactor.Item4, size.Item1, size.Item2, mean.Item1, mean.Item2, mean.Item3, mean.Item4, swapRB, ddepth));
