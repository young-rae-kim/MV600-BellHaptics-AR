...
namespace OpenCVForUnity.DnnModule
{
    public partial class Image2BlobParams : DisposableOpenCVObject
    {
        ...
        public Image2BlobParams(in (double v0, double v1, double v2, double v3) scalefactor, in (double width, double height) size, in (double v0, double v1, double v2, double v3) mean, bool swapRB, int ddepth, in (double v0, double v1, double v2, double v3) borderValue)
        {


            nativeObj = DisposableObject.ThrowIfNullIntPtr(dnn_Image2BlobParams_Image2BlobParams_11(scalefactor.v0, scalefactor.v1, scalefactor.v2, scalefactor.v3, size.width, size.height, mean.v0, mean.v1, mean.v2, mean.v3, swapRB, ddepth, borderValue.v0, borderValue.v1, borderValue.v2, borderValue.v3));
        ...
        public Image2BlobParams(in (double v0, double v1, double v2, double v3) scalefactor, in (double width, double height) size, in (double v0, double v1, double v2, double v3) mean, bool swapRB, int ddepth)
        {
            ...
            nativeObj = DisposableObject.ThrowIfNullIntPtr(dnn_Image2BlobParams_Image2BlobParams_12(scalefactor.v0, scalefactor.v1, scalefactor.v2, scalefactor.v3, size.width, size.height, mean.v0, mean.v1, mean.v2, mean.v3, swapRB, ddepth));
