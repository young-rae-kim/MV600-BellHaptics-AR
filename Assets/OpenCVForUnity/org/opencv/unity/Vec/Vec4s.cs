...
namespace OpenCVForUnity.UnityUtils
{
    ...
    public struct Vec4s : IComparable, IComparable<Vec4s>, IEquatable<Vec4s>, IStructuralComparable, IStructuralEquatable
    {
        public short Item1;
        public short Item2;
        public short Item3;
        ...
        public Vec4s(short item1 = 0, short item2 = 0, short item3 = 0, short item4 = 0)
        {
            Item1 = item1;
            Item2 = item2;
            Item3 = item3;
        ...
        public readonly int CompareTo(object obj)
        {
            ...
            throw new ArgumentException("Object is not a Vec4s");
        }

        // IComparable<Vec4s> implementation
        public readonly int CompareTo(Vec4s other)
        {
        ...
        // IEquatable<Vec4s> implementation
        ...
        // Equality operators
        public static bool operator ==(Vec4s left, Vec4s right)
        {
        ...
        // explicit conversion to ValueTuple<short, short, short, short>
        public static explicit operator (short, short, short, short)(in Vec4s vec)
        {
            return (vec.Item1, vec.Item2, vec.Item3, vec.Item4);
        }

        // explicit conversion from ValueTuple<short, short, short, short>
        public static explicit operator Vec4s(in (short, short, short, short) valueTuple)
        {
            return new Vec4s(valueTuple.Item1, valueTuple.Item2, valueTuple.Item3, valueTuple.Item4);
        }

        public readonly (short, short, short, short) ToValueTuple() => (Item1, Item2, Item3, Item4);
    }
}
