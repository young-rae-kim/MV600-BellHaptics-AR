...
#pragma warning restore 0414
        ...
        private static void CheckForEventSystem()
        {
            ...
            {
                Debug.LogWarning("When using DebugMatUtils, an EventSystem must be added to the scene.");
            }
        }
        ...
        /// </summary>
        /// <remarks>
        /// The setup method adds DebugMatUtils-related GameObjects to the hierarchy. 
